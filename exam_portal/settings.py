...
SECRET_KEY = 'django-insecure-$tk-0y&1f22%l&5li8i1n^d-9om3m-%r@elq=hp43q=f&wq86@'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / "core" / "templates"],  # Correct path
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Database
# You should replace this with PostgreSQL for production if you're using Render
DATABASES = {
    'default': {
